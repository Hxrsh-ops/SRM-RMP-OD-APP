...
class AppDestructiveButton extends StatefulWidget {
  final String label;
  ...
  @override
  State<AppDestructiveButton> createState() => _AppDestructiveButtonState();
}

class _AppDestructiveButtonState extends State<AppDestructiveButton> {
