            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Supporting Documents Section (Requirement 4)
                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          Text('No supporting documents attached.', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
                        ],
                      ),
                    )
                  else
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('${step.actorName} (${step.actorRole}) • ${step.timestamp.toString().split('.')[0]}', style: const TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                                  if (step.note != null && step.note!.isNotEmpty)
                                    Text('Note: "${step.note}"', style: const TextStyle(fontSize: 12, fontStyle: FontStyle.italic, color: AppColors.primaryBlue)),
                                ],
                              ),
                            ),
                          ],
