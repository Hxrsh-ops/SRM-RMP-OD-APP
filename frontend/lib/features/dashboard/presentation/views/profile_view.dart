                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        session?.email ?? 'user@srmist.edu.in',
          ...
          AppCard(
            child: Column(
              ...
              children: [
                ...
                ProfileDetailRow(label: 'Registration / Employee ID', value: session?.username ?? 'RA2511026020400'),
                ProfileDetailRow(label: 'Academic Program', value: session?.program ?? 'B.Tech Computer Science & Engineering'),
                ProfileDetailRow(label: 'Year & Section', value: session?.yearSection ?? '2nd Year - Section G'),
                if (isStudent) ProfileDetailRow(label: 'Assigned Counselor', value: session?.assignedFacultyName ?? 'Dr. Karthik B'),
                const ProfileDetailRow(label: 'Department', value: 'Department of Computer Science & Engineering'),
