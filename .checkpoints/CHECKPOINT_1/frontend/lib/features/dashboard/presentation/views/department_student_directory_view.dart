                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: 11.5, color: Colors.teal.shade800, fontWeight: FontWeight.w600),
                                    ),
                                  ],
                                ),
                              ],
                                  ...
                                  if (latestOd != null) ...[
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Icon(Icons.bolt_rounded, size: 13, color: _getStatusBadgeColor(latestOd['status'] ?? '')),
                                          const SizedBox(width: 3),
                                          Text(
